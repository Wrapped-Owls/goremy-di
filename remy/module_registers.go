...
func WithFactory[T any](binder Binder[T], optTag ...Tag) ModuleRegister {
	return func(i Injector) { RegisterFactory(i, binder, optTag...) }
}

// WithSingleton wraps RegisterSingleton into a ModuleRegister.
func WithSingleton[T any](binder Binder[T], optTag ...Tag) ModuleRegister {
...
func WithLazySingleton[T any](binder Binder[T], optTag ...Tag) ModuleRegister {
