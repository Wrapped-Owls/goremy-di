...
type mapBackendNounsafe[T mapKey] struct {
	m genericAnyMap[T]
}

// newMapBackendNounsafe creates a new map backend without unsafe (direct T keys)
func newMapBackendNounsafe[T mapKey]() StorageBackend[T, any] {
